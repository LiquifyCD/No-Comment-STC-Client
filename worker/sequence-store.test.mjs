...
test('sequence reader resolution is owner scoped and accepts saved authorized reader types',async()=>{
  ...
  sqlite.prepare('INSERT INTO readers VALUES(?,?,?,?,?,?,?,?)').run('catalog-a','owner-a','Main','main',900002,'now',null,null);
...
test('sequence migration preserves existing readers and enforces ordered cascading steps',()=>{
  ...
  sqlite.prepare('INSERT INTO readers VALUES(?,?,?,?,?,?,?)').run('existing','owner','Main','main',900002,'before',null);
