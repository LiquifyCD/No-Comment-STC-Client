...
test('service worker is registered and uses the refreshed shell cache',()=>{assert.match(app,/navigator\.serviceWorker\.register\('\/sw\.js'\)/);assert.match(serviceWorker,/brp-open-v4/)});
