...
const body={name:'Front door',major:'8251',minor:'543516',email:'person@example.test',password:'mock-password'};
...
test('mocked creation authenticates without returning credentials or tokens',async()=>{
  ...
  assert.deepEqual(result,{ok:true,customerId:'own-customer',name:'Front door',nameKey:'front door',major:'8251',minor:'543516'});
