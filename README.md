...
Open the site in Safari, then choose **Share → Add to Home Screen**. Launch the new **BRP Open** icon from the Home Screen to use standalone mode without Safari's address/search bar. A Safari bookmark or normal Safari tab always keeps Safari's controls.
