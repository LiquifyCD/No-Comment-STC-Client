/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0eda4e31bb044a626daa03e598e54238)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 nodejs_compat
interface __BaseEnv_Env {
	SESSIONS: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	BRP_BASE_URL: "https://stc.brpsystems.com/brponline/api/ver3";
	BRP_APP_ID: "383";
	PASSAGE_ENABLED: "true";
	PROACTIVE_REFRESH_ENABLED: "false";
	SCHEDULED_REAUTH_ENABLED: "true";
	SESSION_ENCRYPTION_KEY: string;
	PASSAGE_AUTHORIZATION_ID: string;
	READER_CATALOG: string;
	OPEN_DOOR_API_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BRP_BASE_URL" | "BRP_APP_ID" | "PASSAGE_ENABLED" | "PROACTIVE_REFRESH_ENABLED" | "SCHEDULED_REAUTH_ENABLED" | "SESSION_ENCRYPTION_KEY" | "PASSAGE_AUTHORIZATION_ID" | "READER_CATALOG" | "OPEN_DOOR_API_KEY">> {}
}
